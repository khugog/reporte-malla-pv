...
from reporte_malla_pv import generar_reporte_malla_pv, FORMATOS_CONFIG

# --- Streamlit Interface ---
st.set_page_config(page_title="Reporte Malla Aprendizaje", layout="wide")
st.title('Generador de Reporte Malla Aprendizaje')
...
if st.button('Generar Reporte Malla', type="primary"):
    if uploaded_files:
        generar_reporte_malla_pv(uploaded_files, formato=formato)
    else:
